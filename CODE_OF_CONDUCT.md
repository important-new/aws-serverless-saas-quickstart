...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at GitHub's private reporting on this repository (Security > Report a vulnerability) or by contacting the project maintainer ([@important-new](https://github.com/important-new)) privately. All complaints will be reviewed and investigated promptly and fairly.
...
社区领导有权力和责任删除、编辑或拒绝与本行为准则不相符的评论（comment）、提交（commits）、代码、维基（wiki）编辑、议题（issues）或其他贡献，并在适当时机告知采取措施的理由。
...
辱骂、骚扰或其他不可接受的行为可通过 本仓库的 GitHub 私密举报（Security > Report a vulnerability），或私下联系项目维护者（[@important-new](https://github.com/important-new)） 向负责监督的社区领袖报告。 所有投诉都将得到及时和公平的审查和调查。
